...
class Continent {
	...
	protected static $nom_table="continents"; 
	protected static $champs = array('id','code','name', 'display_order');
  ...
  public function nom_compler() {
	...
	public static function trouve_tous() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." ORDER BY `display_order` ASC");
  }
	public static function trouve_id_and_name_CCI() {
		return self::trouve_par_sql("SELECT id,name FROM ".self::$nom_table." ORDER BY `display_order` ASC");
  }
	public static function trouve_id_and_name() {
		return self::trouve_par_sql("SELECT id,name FROM ".self::$nom_table." where id != 8 ORDER BY `display_order` ASC");
  }
  ...
  public static function trouve_par_id($id=0) {
   ...
   public static function trouve_par_alpha2($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE alpha2 ='$id' LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
